...
class pilot(wx.Frame):
	def __init__(self, parent, id):
	    ...
	    self.dw, self.dh = wx.DisplaySize()
            ...
            wx.Frame.__init__(self , parent , id, 'songPilot', size = (220, 400), pos = (self.dw - 225, self.dh - 735) )
	...
	def initializeParameters(self):
	    ...
	    if self.control != 'tracker':	    
		    ...
		    # self.mouseCursor.move( *self.mousePosition )	
                    self.mouseCursor.move( self.dw - 10, self.dh - 345 )	
			...
			if self.flag == 'row':
				...
				if self.rowIteration == 0 or self.rowIteration == 1:
					...
					self.rowIteration = 0
                                        ...
                                        os.system( 'wid=`xdotool search --onlyvisible --name SMPlayer` && xdotool windowfocus $wid && xdotool key --window $wid f &&wid=`xdotool search --onlyvisible --name songPilot` && xdotool windowactivate $wid' )
