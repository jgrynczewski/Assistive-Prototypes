                ...
                if self.control == 'eye':
                            ...
                            for item in items:
                                ...
                                if b.GetBackgroundColour() != self.colour and b.mode != 'confirmation':
                                    if (b.Name == "yes" and b.GetBackgroundColour().Blue() < 50 or b.Name == "no" and b.GetBackgroundColour().Red() > 250 or b.Name == "back" and b.GetBackgroundColour().Blue() < 50 ):
                                        ...
                                        if b.Name == 'yes':                                    
                                                ...
                                                b.SetBackgroundColour(wx.Colour(b.GetBackgroundColour().Red()+5,b.GetBackgroundColour().Green(),b.GetBackgroundColour().Blue(), b.GetBackgroundColour().Alpha()))
                                        elif b.Name == 'back':                                                    
